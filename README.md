...
`npm run check` checks types and runs 100 seeds for every lesson, checking grading, duplicate choices, answer formatting and arithmetic parsing. This does not replace a math teacher's review. Browser verification covers navigation, study interactions, storage, backups and responsive layouts.
...
See the site's **Sources & standards** page for curriculum, learning-design references and creator credits.
